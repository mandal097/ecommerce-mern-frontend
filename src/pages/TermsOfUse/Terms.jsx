...
const Terms = () => {
    return (
        <div className={styles.terms}>
            ...
            <p>By visiting our Website and/ or purchasing something from us, you engage in our <span>“Service” </span> and agree to be bound by the following terms and conditions <span> (“Terms of Service”, “Terms”)</span>, including those additional terms and conditions and policies referenced herein and/or available by hyperlink. These Terms of Service apply to all users of the Website, including without limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content. In the event there is any conflict or inconsistency between these Terms and any other term or condition on the Website, these Terms shall prevail.</p>
            ...
            <div className={styles.details}>
                ...
                <div className={styles.list_items}>
                    ...
                    <div className={styles.dot}><div></div>Credit Card </div>
                    <div className={styles.dot}><div></div>UPI </div>
                    <div className={styles.dot}><div></div>Net-Banking </div>
                    <div className={styles.dot}><div></div> Google Pay</div>
                    <div className={styles.dot}><div></div>AMEX </div>
                    <div className={styles.dot}><div></div>Wallets (Phone Pe, Amazon Pay, Freecharge, OLA Money, Airtel Money, PayZapp) </div>
                    <div className={styles.dot}><div></div>Pay Later (Simpl, ICICI PayLater) </div>
                    <p>Please direct your queries regarding delayed refunds, chargebacks, payment failures and double debits to our payment service providers PayU Payments Private Limited and RazorPay Software Private Limited which provide and manage our payment solutions, payment gateway aggregation and facilitate the initiation and receipt of electronic payments, including but not limited to payments effected through credit cards, debit cards, net-banking, pre-paid instruments and payment methods.</p>
                </div>

                <div className={styles.list_items}>
                    <div className={styles.dot}><div></div> Shipping</div>
                    <p>Your total cost for the purchase of any product will include shipping and handling charges.</p>
                    <p>Our shipping partners include –</p>
                    <div className={styles.dot}><div></div> Nimbus Post</div>
                    <div className={styles.dot}><div></div> Shyplite (Simba Logistics Private Limited)</div>
                    <p>Orders are also delivered via Delhivery, BlueDart, Xpress Bees, DTDC, ShipRocket, Pickkr, WareIQ, Rivia, pidge, and Ecomm Express.</p>
                    <p>For the delivery of the Big Brew Box, Little Brew Box and Classic and Sweet bottles within the Delhi NCR, delivery is done by our own delivery staff.</p>
                    <p>Depending on factors like location, connectivity, etc., orders are usually delivered within 5-7 days of placing the order.</p>
                ...
                <div className={styles.list_items}>
                    <div className={styles.dot}><div></div> Return and Refund</div>
                    <p>We will process refund and return requests as per our Refunds and Return Policy available here.</p>
                </div>
            ...
            <div className={styles.details}>
                <span className={styles.heading}>4. Product</span>
                <p>We sell hot and trendy products in fashion for both boys and girls, electronics, furnitures, TV & Appliances, Mobiles & Tablets, Beauty products, and Groceries.</p>
            </div>


            <div className={styles.details}>
                <span className={styles.heading}>5. Grievance Redressal Mechanism</span>
                <p>If you have any questions or feedback you may contact our customer care at +91-8882330518 or write to us at amarnathmandal097@gmail.com</p>

                <p>Upon receiving your complaint, we will send an acknowledgement along with a ticket number within 48 hours and resolve the issue in a timebound manner within a period of one month.</p>

                <p>Questions about the Terms of Service should be sent to us at amarnathmandal097@gmail.com</p>
            </div>
